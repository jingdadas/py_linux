...
try:
    ...
    import psutil
    import platform
    #import commands   【python3没有该模块，使用subprocess替代】
    import subprocess
    import json
    import socket
    import os
...
class SysInfo():
    ...
    def CPU(self):
        ...
        cpu_label = str(subprocess.getoutput('grep "model name" /proc/cpuinfo | awk -F ": " \'{print $2}\' | head -1'))
        cpu_cache = str(subprocess.getoutput('grep "cache size" /proc/cpuinfo|uniq|awk \'{print $4,$5}\''))
